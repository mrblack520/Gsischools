 document.addEventListener('DOMContentLoaded', () => {
            ...
            const universityChoice3 = new Choices("#university-select-3", {
                searchEnabled: true,
                placeholderValue: 'Select university',
                searchPlaceholderValue: 'Search university...',
                shouldSort: false,
            ...
            const universityChoices4 = new Choices("#university-select-4", {
                searchEnabled: true,
                placeholderValue: 'Select university',
                searchPlaceholderValue: 'Search university...',
                shouldSort: false,
            ...
            const courseChoice3 = new Choices("#course-select-3", {
                searchEnabled: true,
                placeholderValue: 'Select course',
                searchPlaceholderValue: 'Search course...',
                shouldSort: false,
            ...
            const courseChoices4 = new Choices("#course-select-4", {
                searchEnabled: true,
                placeholderValue: 'Select course',
                searchPlaceholderValue: 'Search course...',
                shouldSort: false,
            ...
            const statusChoices3 = new Choices("#status-select-3", {
                searchEnabled: true,
            ...
            const statusChoices4 = new Choices("#status-select-4", {
                searchEnabled: true,
                placeholderValue: 'Select status',
                searchPlaceholderValue: 'Search course...',
                shouldSort: false,
            ...
            const practiceAreaChoices = new Choices("#practice-area-select", {
                placeholderValue: 'Select practice area',
                shouldSort: false,
                itemSelectText: '',
                searchEnabled: false,
            })

            const titleChoices = new Choices("#pa-title-select", {
            ...
            const institutionChoices = new Choices("#institution-select", {
                placeholderValue: 'Select institution type',
                shouldSort: false,
                itemSelectText: '',
                searchEnabled: false,
            })

            const countryChoice1 = new Choices('#country-select-1', {
                removeItemButton: true,
                placeholderValue: 'Select countries',
                searchPlaceholderValue: 'Search country...',
            });

            const countryChoice2 = new Choices('#country-select-2', {
                removeItemButton: true,
                placeholderValue: 'Select countries',
                searchPlaceholderValue: 'Search country...',
            });
            ...
            //         countryChoice2.setChoices(countryOptions, 'value', 'label', false);
            //     });

            document.getElementById("up-submit-btn").addEventListener("click", () => {
                Swal.fire({
                    title: 'Submitted!',
                    ...
                    window.location.href = route('frontend.optional-university-profession-form');
                })
            })
            ...
            let addAnotherUniBtn2 = document.querySelector(".add-another-2");
            addAnotherUniBtn2.addEventListener("click", () => {
                addAnotherUniBtn2.style.display = "none";
                document.querySelectorAll(".add-course-2, .add-university-2, .add-status-2").forEach(element => {
                    element.style.display = "block";
                    setTimeout(() => {
                        element.style.opacity = 1;
                    }
