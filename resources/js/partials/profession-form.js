        ...
        document.getElementById("profession-submit-btn").addEventListener("click", () => {
            Swal.fire({
                title: 'Submitted!',
                ...
                window.location.href = "{{ route('frontend.optional-profession-form') }}";
            })
        })

        document.getElementById("profession-save-btn").addEventListener("click", () => {
            Swal.fire({
                title: 'Saved!',
