document.addEventListener('DOMContentLoaded', () => {
            ...
            document.getElementById("op-profession-submit-btn").addEventListener("click", () => {
                Swal.fire({
                    ...
                    window.location.href = route('frontend.register');
                })
            })

            document.getElementById("op-profession-save-btn").addEventListener("click", () => {
                Swal.fire({
                    title: 'Saved!',
