...
@section('content')
    ...
    <section class="contact-us-banner">
        <div class="text-center">
            <h4>University and Profession Registration Form</h4>
        ...
        <div class="container mt-4">
            <div class="row d-flex justify-content-between">
                <div class="col-md-5 left d-flex justify-content-center flex-column">
                    <h2 class="inner-sub-heading mt-0">University and Profession Aficionado registration form</h2>
        ...
        <div class="container">
            <form class="registeration-form">
                <div class="row">
                        ...
                        <div class="form-wrapper">
                            ...
                            <div class="input-wrapper university-dropdown custom-dropdown">
                                <select id="university-select" class="form-select custom-select" name="university"
                                    ...
                                    <option value="lse"
                                        data-name="London School of Economics and Political Science (LSE)">
                                        London School
                            ...
                            <div class="input-wrapper checkbox-wrapper">
                                <div class="checkbox-con">
                                    <label class="custom-checkbox">
                                        <input type="checkbox">
                                        <span class="checkmark"></span>Student Accommodation
                                    </label>
                                </div>
                                <div class="checkbox-con">
                                    <label class="custom-checkbox">
                                        <input type="checkbox">
                                        <span class="checkmark"></span>Flat share
                                    </label>
                                </div>
                                <div class="checkbox-con">
                                    <label class="custom-checkbox">
                                        <input type="checkbox">
                                        <span class="checkmark"></span>Living at home
                                    </label>
                                </div>
                                <div class="checkbox-con">
                                    <label class="custom-checkbox">
                                        <input type="checkbox" class="toggle-checkbox"
                                            data-toggle-target="#accommodation-textbox">
                                        <span class="checkmark"></span> Other, please specify
                                    </label>
                                </div>

                                <div class="checkbox-con w-100 write-your-status" id="accommodation-textbox">
                                    <input type="text" placeholder="Write here...">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-wrapper">
                            <label for="university-select-3">University</label>
                            <div class="input-wrapper university-dropdown custom-dropdown">
                                <select id="university-select-3" class="form-select custom-select" name="university"
                                    data-other-id="university3-textbox">
                                    <option value="aston-university" data-name="Aston University">Aston University
                                    </option>
                                    <option value="cardiff-university" data-name="Cardiff University">Cardiff University
                                    </option>
                    ...
                    <div class="col-md-4">
                        <div class="form-wrapper mb-0">
                            <label for="course-select-3">Course</label>
                            <div class="input-wrapper university-dropdown custom-dropdown">
                                <select id="course-select-3" class="form-select custom-select" name="university"
                                    data-other-id="course3-textbox">
                                    <option value="accounting-finance" data-name="Accounting and Finance">Accounting and
                                        Finance</option>
                                    <option value="actuarial-science" data-name="Actuarial Science">Actuarial Science
                                    </option>
                    ...
                    <div class="col-md-4">
                        <div class="form-wrapper mb-0">
                            <label for="status-select-3">Status</label>
                            <div class="input-wrapper university-dropdown custom-dropdown">
                                <select id="status-select-3" class="form-select custom-select" name="university"
                                    data-other-id="status3-textbox">
                                    <option value="first-year" data-name="Accounting and Finance">1st year</option>
                                    <option value="intermediate-year" data-name="Actuarial Science">Intermediate year
                                    </option>
                                    <option value="final-year" data-name="Actuarial Science">Final year
                            ...
                            <div class="mt-3 d-flex justify-content-end">
                                <a class="add-another-2" href="javascript:void(0)">Add another university and course</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 add-university-2">
                        <div class="form-wrapper">
                            <label for="university-select-4">Choose another university</label>
                            <div class="input-wrapper university-dropdown custom-dropdown">
                                <select id="university-select-4" class="form-select custom-select" name="university"
                                    data-other-id="university4-textbox">
                                    <option value="aston-university" data-name="Aston University">Aston University
                                    </option>
                                    <option value="cardiff-university" data-name="Cardiff University">Cardiff University
                                    </option>
                                ...
                                <div class="checkbox-con w-100 write-your-status dropdown-textbox "
                                    id="university4-textbox">
                                    <input type="text" placeholder="Write here...">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 add-course-2">
                        <div class="form-wrapper">
                            <label for="course-select-4">Choose another course</label>
                            <div class="input-wrapper university-dropdown custom-dropdown">
                                <select id="course-select-4" class="form-select custom-select" name="university"
                                    data-other-id="course4-textbox">
                                    <option value="accounting-finance" data-name="Accounting and Finance">Accounting and
                                        Finance</option>
                                    <option value="actuarial-science" data-name="Actuarial Science">Actuarial Science
                                    </option>
                    ...
                    <div class="col-md-4 add-status-2">
                        <div class="form-wrapper mb-0">
                            <label for="status-select-4">Status</label>
                            <div class="input-wrapper university-dropdown custom-dropdown">
                                <select id="status-select-4" class="form-select custom-select" name="university"
                                    data-other-id="status4-textbox">
                                    <option value="first-year" data-name="Accounting and Finance">1st year</option>
                                    <option value="intermediate-year" data-name="Actuarial Science">Intermediate year
                                    </option>
                                    <option value="final-year" data-name="Actuarial Science">Final year
                    ...
                    <div class="d-flex gap-3 save-or-submit mb-5">
                        <div class="mt-4">
                            <a id="up-save-btn" href="javascript:void(0)">Save and continue later</a>
                        </div>
                        <div class="mt-4">
                            <a id="up-submit-btn" href="javascript:void(0)">Submit</a>
                        </div>
                    </div>
...
@section('script')
    ...
    @vite('resources/js/partials/university-profession-form.js')
