...
@section('content')
    ...
    <section class="filter-sec example-question-sec pt-0">
        <div class="container">
            ...
            <p class="contact-message mt-1 text-sm">Explore our Frequently Asked Questions and find helpful information tailored for School, Academy, and Other Services.
            </p>
            <div class="row d-flex">
                <div class="d-flex eq-tabs">
                    <div class="filter-con active" onclick="changeTab('general', this)">
                        <span>School</span>
                    </div>
                    <div class="filter-con" onclick="changeTab('nextgen', this)">
                        <span>Academy</span>
                    </div>
                    <div class="filter-con" onclick="changeTab('profession', this)">
                        <span>Co-Curriculum</span>
                    </div>
                    <div class="filter-con" onclick="changeTab('all', this)">
                        <span>Faculty</span>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-wrapper">
                        <div class="input-wrapper">
                            <input type="text" id="password" placeholder="Search topic">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
                    ...
                    <div class="col-md-3">
                        <aside class="faq-sidebar">
                            ...
                            <ul>
                                ...
                                <li><a data-target="about" class="sidebar-link" href="#About" id="link-About">Academics & Curriculum</a>
                                </li>
                                <li><a data-target="sessions" class="sidebar-link" href="#Sessions"
                                        id="link-Sessions">School Life & Facilities</a></li>
                                <li><a data-target="account" id="link-Account" href="#Account"
                                        class="sidebar-link">Fees & Policies</a></li>
                            </ul>
                        </aside>
                    </div>
                    <div class="col-md-9">
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="accordion__item">
                                            ...
                                            <div class="accordion__content" id="faq2">
                                                <p>
                                                   Guiding Star International is currently offering admissions from Pre-Primary (Mont Junior, Mont Senior, and Mont Advance) up to Grade 10 (Matriculation depending on the stream chosen). Availability of seats may vary for each class, so parents are encouraged to contact the school office for updated information about open slots.
                                                </p>
                                        ...
                                        <div class="accordion__item">
                                          ...
                                          Is there any admission test or interview?
                                            ...
                                            <div class="accordion__content" id="faq3">
                                                <p>Yes. Guiding Star International conducts a short written assessment (age and grade-appropriate) followed by an interview with the student and parents. This ensures the child is placed in the most suitable class and learning environment.g
                                                    </p>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="accordion__item">
                                            ...
                                            <div class="accordion__content" id="faq4">
                                                <p>
                                                    Yes, transfers are allowed subject to seat availability and submission of the school leaving certificate along with the latest report card from the previous institution. Admission tests/interviews may still be required to ensure a smooth transition.
                                                </p>
                        ...
                        <div class="faq-category-con" id="About">
                            ...
                            <div class="row">
                                <div class="faq-con">
                                    <div class="col-md-12 mb-4">
                                        <div class="accordion__item">
                                            <div class="accordion__header" data-toggle="#afaq1">Which curriculum does Guiding Star International follow?
                                            </div>
                                            <div class="accordion__content" id="afaq1">
                                                
                                                <p>Guiding Star International follows a well-structured curriculum that combines national educational standards with modern teaching approaches to prepare students for both local and international opportunities.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="accordion__item">
                                            ...
                                            <div class="accordion__content" id="afaq2">
                                               <p>1. <strong>Primary (Nursery – Grade 5):</strong> English, Urdu, Mathematics, General Science, Social Studies, Islamic Studies, Computer, Arts, and Physical Education.</p>
                                                <p>2. <strong>Middle (Grade 6 – 8):</strong>English, Urdu, Mathematics, General Science, Social Studies, Islamic Studies, Computer, Arts, and Physical Education with advanced concepts.</p>
                                                <p>3. <strong>Secondary (Grade 9 – 10):</strong>English, Urdu, Mathematics, Physics, Chemistry, Biology/Computer Science, Pakistan Studies, and Islamic Studies.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="accordion__item">
                                            <div class="accordion__header" data-toggle="#cfaq3">
                                               Do you offer Pre-Medical, Pre-Engineering, or Computer Science at the higher levels?
                                            </div>
                                            <div class="accordion__content" id="cfaq3">
                                                <p>Yes, at the Higher Secondary (Intermediate) level, students can choose from the following groups:</p>
                                                ...
                                                <p>3. <strong>Computer Science</strong>(Physics, Mathematics, Computer Science)</p>
                                            ...
                                            <div class="accordion__content" id="dfaq4">
                                               <p>We use a comprehensive assessment system that includes:</p>
                                                ...
                                                <p>3. <strong>Projects, research work, and presentations</strong></p>
                                                  <p>4. <strong>Teacher observations and participation in activities</strong></p>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="accordion__item">
                                            ...
                                            <div class="accordion__content" id="ffaq2">
                                                <p>
                                                    Currently, the school does not provide pick-and-drop facilities. Parents/guardians are responsible for student transportation.
                                                </p>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="accordion__item">
                                            ...
                                            <div class="accordion__content" id="hfaq4">
                                                ...
                                                <p>2. <strong>Science labs (Physics, Chemistry, Biology) for practical learning</strong></p>
                        ...
                        <div class="faq-category-con mb-0" id="Account">
                            ...
                            <div class="row">
                                <div class="faq-con">
                                    <div class="col-md-12 mb-4">
                                        <div class="accordion__item">
                                            <div class="accordion__header" data-toggle="#jfaq1">What is the fee structure for different classes?
                                            </div>
                                            <div class="accordion__content" id="jfaq1">
                                                <p>Our fee structure is affordable and varies according to the grade level. Parents can contact the school office for detailed class-wise fee information.</p>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="accordion__item">
                                            ...
                                            <div class="accordion__content" id="kfaq2">
                                                <p>
                                                    Yes, a one-time admission/registration fee is applicable at the time of enrollment.
                                                </p>
                                ...
                                <div class="faq-con">
                                    <div class="col-md-12 mb-4">
                                        <div class="accordion__item">
                                            <div class="accordion__header" data-toggle="#lfaq3">How can parents pay the fee (monthly/quarterly)?
                                            </div>
                                            <div class="accordion__content" id="lfaq3">
                                                <p>Fee is payable on a monthly basis at the school office during working hours.</p>
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="accordion__item">
                                            ...
                                            <div class="accordion__content" id="ifaq4">
                                                <p>
                                                    Yes, we offer special concessions for siblings to support families with more than one child enrolled in our school.
                                                </p>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="accordion__item">
                                            ...
                                            <div class="accordion__content" id="faq9">
                                                <p>
                                                   We provide coaching from Mont Junior to Grade 10 and onward for Matric & Intermediate students.
                                                </p>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="accordion__item">
                                            ...
                                            <div class="accordion__content" id="faq10">
                                                <p>
                                                    Yes. We offer specialized entry test preparation for schools, colleges, and universities.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="accordion__item">
                                            ...
                                            <div class="accordion__content" id="faq11">
                                                <p>We provide coaching for Sindh Board, Balochistan Board, Ziauddin Board,Federal Board,Matric, and Intermediate.</p>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="accordion__item">
                                            ...
                                            <div class="accordion__content" id="faq12">
                                                <p>Yes, we arrange revision and crash courses before exams for maximum preparation.</p>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="accordion__item">
                                            ...
                                            <div class="accordion__content" id="ng-a-faq9">
                                                <p>
                                                   Yes, we run English Language programs focusing on grammar, fluency, and confidence.
                                                </p>
                                                <p>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="accordion__item">
                                            ...
                                            <div class="accordion__content" id="ng-a-faq10">
                                                <p>
                                                   Yes. We provide Computer Courses (AI, Cybersecurity, Web Development, Office Tools, etc.).
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="accordion__item">
                                            ...
                                            <div class="accordion__content" id="ng-a-faq11">
                                                <p>Yes, our soft skills training helps students with communication, leadership, and confidence.</p>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="accordion__item">
                                            ...
                                            <div class="accordion__content" id="ng-a-faq12">
                                                <p>Of course! Our language and computer courses are open for both students and professionals.</p>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="accordion__item">
                                            ...
                                            <div class="accordion__content" id="ng-b-faq9">
                                                <p>
                                                    Absolutely! Students from different schools can enroll in our academy coaching and skill programs.
                                                </p>
                                ...
                                <div class="faq-con">
                                    <div class="col-md-12 mb-4">
                                        <div class="accordion__item">
                                            ...
                                            <div class="accordion__content" id="faq10">
                                                <p>
                                                   Yes, for some classes we conduct an entry test to place students at the right level.
                                ...
                                <div class="faq-con">
                                    <div class="col-md-12 mb-4">
                                        <div class="accordion__item">
                                            ...
                                            <div class="accordion__content" id="faq11">
                                                <p>We combine modern learning techniques, digital tools, and expert faculty guidance.</p>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="accordion__item">
                                            ...
                                            <div class="accordion__content" id="ng-c-faq9">
                                                <p>
                                                   Through regular updates, WhatsApp groups, and official channels, plus meetings.
                                                </p>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="accordion__item">
                                            ...
                                            <div class="accordion__content" id="ng-c-faq10">
                                                <p>
                                                   Yes, we share resources and updates online to ensure continuous learning.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="accordion__item">
                                            ...
                                            <div class="accordion__content" id="ng-c-faq11">
                                                <p>Yes, we run dedicated WhatsApp groups/channels for classes and announcements.</p>
                    ...
                    <div class="col-md-3">
                        <aside class="faq-sidebar">
                            ...
                            <ul>
                                ...
                                <li><a data-target="af-about" class="sidebar-link" href="#af-about"
                                        id="link-af-about">Arts & Creativity</a></li>
                                        ...
                                        <div class="accordion">
                                            <div class="accordion__item">
                                                ...
                                                <div class="accordion__content" id="faq13">
                                                    <p>
                                                       We offer cricket, football, badminton, athletics, and other fitness activities.
                                                    </p>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="accordion__item">
                                            ...
                                            <div class="accordion__content" id="faq14">
                                                <p>Yes, GSI organizes annual sports week and also encourages participation in inter-school events.</p>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="accordion__item">
                                            ...
                                            <div class="accordion__content" id="faq16">
                                                <p>Absolutely! Students receive certificates, medals, and awards for their performance.</p>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="accordion__item">
                                            ...
                                            <div class="accordion__content" id="af-a-faq14">
                                                <p>Yes, students can showcase their talent in annual science, art, and project exhibitions.</p>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="accordion__item">
                                            ...
                                            <div class="accordion__content" id="af-a-faq15">
                                                <p>Most are optional, but students are encouraged to participate for overall development.</p>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="accordion__item">
                                            ...
                                            <div class="accordion__content" id="af-a-faq16">
                                                <p>Yes, we support students in participating at inter-school and city-level competitions.</p>
                                        ...
                                        <div class="accordion">
                                            <div class="accordion__item">
                                                ...
                                                <div class="accordion__content" id="af-b-faq13">
                                                    <p>
                                                        Through debates, speeches, and declamation contests, students gain public speaking skills.
                                                    </p>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="accordion__item">
                                            ...
                                            <div class="accordion__content" id="af-b-faq14">
                                                <p>Yes, we have student councils and clubs where learners can practice leadership</p>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="accordion__item">
                                            ...
                                            <div class="accordion__content" id="af-b-faq15">
                                                <p>Definitely, GSI regularly arranges quizzes, Model UN, and knowledge competitions.</p>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="accordion__item">
                                            ...
                                            <div class="accordion__content" id="af-b-faq16">
                                                <p>They prepare students for future challenges, building teamwork and decision-making skills.</p>
                                        ...
                                        <div class="accordion">
                                            <div class="accordion__item">
                                                ...
                                                <div class="accordion__content" id="af-c-faq13">
                                                    <p>
                                                      Yes, we conduct study tours and educational trips for practical exposure.
                                                    </p>
            ...
            <div id="all" class="faq-section">
                <div class="row d-flex justify-content-center">
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="accordion__item">
                            <div class="accordion__header" data-toggle="#aafaq1">How can I apply to join GSI as faculty?</div>
                            <div class="accordion__content" id="aafaq1">
                                <p>You can apply directly through our website’s faculty registration form or submit your CV to the administration office.</p>
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="accordion__item">
                            ...
                            <div class="accordion__content" id="aafaq2">
                                <p>
                                   Minimum requirement is a Bachelor’s degree in the relevant subject. For senior classes, a Master’s degree or higher is preferred.
                                </p>
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="accordion__item">
                            ...
                            <div class="accordion__content" id="afaq3">
                                <p>Experience is preferred but fresh graduates with strong knowledge and communication skills are also encouraged to apply.</p>
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="accordion__item">
                            ...
                            <div class="accordion__content" id="afaq9">
                                <p>
                                    Faculty can teach school subjects (Grade Playgroup–10), board exam preparation, English language, and computer courses.
                                </p>
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="accordion__item">
                            ...
                            <div class="accordion__content" id="afaq10">
                                <p>
                                   Faculty are expected to maintain discipline, mentor students, and support co-curricular activities.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="accordion">
                            <div class="accordion__item">
                                ...
                                <div class="accordion__content" id="afaq13">
                                    <p>
                                       Salaries are based on qualifications, teaching experience, and subjects handled. Details are shared after the interview.
                                    </p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 left">
                    <div>
                        <h2 class="mb-2"><span>Trending Articles</span></h2>
                        <h3><img src="./assets/images/dark-bullets.svg" alt="bullets" class="ms-2 me-2 mb-2"> Articles
                            coming soon</h3>
                        <h3><img src="./assets/images/dark-bullets.svg" alt="bullets" class="ms-2 me-2 mb-2"> Articles
                            coming soon</h3>
                        <h3><img src="./assets/images/dark-bullets.svg" alt="bullets" class="ms-2 me-2 mb-2"> Articles
                    ...
                    <!-- <p></p> -->
                    <!-- <div>
                        <a href="javascript:void(0)" class="account-about-btn">Lorem ipsum dolor sit</a>
                    </div> -->
                </div>
