   <section class="mentoring-sec mt-5">
        <div class="bg-effect"></div>
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-md-3">
                    <div class="left">
                        <h3 class="inner-sub-heading">Is this like <span>mentoring</span> or <span>tutoring?</span></h3>
                        <img src="./assets/images/portrait-3d-male-doctor.webp" alt="GSI Schools doctor man carton">
                    </div>
                </div>
                <div class="col-md-9">
                    <div class="right">
