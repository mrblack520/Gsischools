...
<?php $component = App\View\Components\News::resolve(['colum' => pagesetting('news_area_column'),'count' => pagesetting('news_count'),'readmore' => pagesetting('read_more_btn'),'sorting' => pagesetting('news_sorting')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<!-- blog area end --><?php /**PATH /home/gsistiww/public_html/portal/resources/views/themes/edulia/pagebuilder/news-section/view.blade.php ENDPATH**/ ?>