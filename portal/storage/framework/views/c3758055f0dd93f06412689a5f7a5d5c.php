                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="white-box">
                                ...
                                <?php if(isset($id_card)): ?>
                                    <?php echo e(html()->form('PUT', route('student-id-card-update', @$id_card->id))->attributes([
                                ...
                                <?php else: ?>
                                    <?php if(userPermission('create-id-card')): ?>
                                        <?php echo e(html()->form('POST', route('store-id-card'))->attributes([
                                                'class' => 'form-horizontal',
                                                'files' => true,
                                                'enctype' => 'multipart/form-data',
                                            ])->open()); ?>
                                ...
                                <?php echo $__env->make('backEnd.admin.idCard.form_id_card', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    ...
                    <div class="sticky_card white-box">
                        ...
                        <div class="mt-10">
                            <?php if(isset($id_card)): ?>
                                ...
                                <?php echo $__env->make('backEnd.admin.idCard.edit_view_id_card', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                <?php echo $__env->make('backEnd.admin.idCard.guardian_edit_view', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php else: ?>
                                <?php echo $__env->make('backEnd.admin.idCard.add_view_id_card', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                <?php echo $__env->make('backEnd.admin.idCard.guardian_add_view_id_card', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            changeSignature = (status) => {
                const reuired_placeholder =
                    "<?php echo e(isset($id_card) ? ($id_card->signature != '' ? getFilePath3($id_card->signature) : trans('admin.signature') . ' *') : trans('admin.signature') . ' *'); ?>";
                const nullable_placeholder =
                    "<?php echo e(isset($id_card) ? ($id_card->signature != '' ? getFilePath3($id_card->signature) : trans('admin.signature') . ' *') : trans('admin.signature')); ?>";
                if (pageLayout == "horizontal") {
                    if (status == "1") {
                        $(".hSign").show();
        ...
        $(document).on("click", "#deleteBackImg", function(event) {
            ...
            if (pageLayout == "horizontal") {
                ...
                $('.hr_bg').attr('style',
                    'line-height:1.02; background-image: url(<?php echo e(asset('public/backEnd/id_card/img/horizontal_bg.png')); ?>); width: 86mm; height: 54mm; margin: auto; background-size: 100% 100%; background-position: center center; position: relative;'
                    );
            } else {

                $('.vr_bg').attr('style',
                    'line-height:1.02; background-image: url(<?php echo e(asset('public/backEnd/id_card/img/vertical_bg.png')); ?>); width: 57.15mm; height: 88.9mm; margin: auto; background-size: 100% 100%; background-position: center center; position: relative; background-color: #fff; display: flex; flex-direction: column;'
                    );
            }
        });
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/gsistiww/public_html/portal/resources/views/backEnd/admin/idCard/student_id_card.blade.php ENDPATH**/ ?>