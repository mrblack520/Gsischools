            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            <?php if(isset($feesType)): ?>
                                <?php echo e(html()->form('POST', route('fees.fees-type-update'))->attributes(['class' => 'form-horizontal'])->open()); ?>

                                <input type="hidden" name="id" value="<?php echo e(isset($feesType) ? $feesType->id : ''); ?>">
                            <?php else: ?>
                                <?php if(userPermission('fees.fees-type-store')): ?>
                                    <?php echo e(html()->form('POST', route('fees.fees-type-store'))->attributes(['class' => 'form-horizontal'])->open()); ?>
                                ...
                                <div class="add-visitor">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <input
                                                    ...
                                                    value="<?php echo e(isset($feesType) ? $feesType->name : old('name')); ?>">
                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-12">
                                            ...
                                            <select
                                                class="primary_select  form-control<?php echo e($errors->has('fees_group') || session()->has('message-exist') ? ' is-invalid' : ''); ?>"
                                                name="fees_group" id="fees_group"
                                                <?php echo e(isset($fees_master) ? 'disabled' : ''); ?>>
                                                <option data-display="<?php echo app('translator')->get('fees.fees_group'); ?>" value=""><?php echo app('translator')->get('fees.fees_group'); ?>
                                                </option>
                                                <?php $__currentLoopData = $feesGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feesGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if(isset($feesType)): ?>
                                                        <option
                                                            value="<?php echo e($feesGroup->id); ?>"<?php echo e($feesGroup->id == $feesType->fees_group_id ? 'selected' : ''); ?>>
                                                            <?php echo e($feesGroup->name); ?> </option>
                                                    <?php else: ?>
                                                        <option value="<?php echo e($feesGroup->id); ?>"
                                                            <?php echo e(old('fees_group') != '' ? (old('fees_group') == $feesGroup->id ? 'selected' : '') : ''); ?>>
                                                            <?php echo e($feesGroup->name); ?></option>
                                                    <?php endif; ?>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for=""><?php echo app('translator')->get('common.description'); ?>
                                                    <span></span></label>
                                                <textarea class="primary_input_field form-control" cols="0" rows="4" name="description"><?php echo e(isset($feesType) ? $feesType->description : old('description')); ?></textarea>
...
<?php $component->withAttributes([]); ?>
                                                            <?php if(userPermission('fees.fees-type-edit')): ?>
                                                                <a class="dropdown-item"
                                                                    href="<?php echo e(route('fees.fees-type-edit', [$feesType->id])); ?>"><?php echo app('translator')->get('common.edit'); ?></a>
                                                            <?php endif; ?>
                                                            <?php if(userPermission('fees.fees-type-delete')): ?>
                                                                <a class="dropdown-item" data-toggle="modal"
                                                                    data-target="#deleteFeesTypeModal<?php echo e($feesType->id); ?>"
...
<?php endif; ?>
                                                ...
                                                <div class="modal fade admin-query"
                                                    id="deleteFeesTypeModal<?php echo e($feesType->id); ?>">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mt-40 d-flex justify-content-between">
                                                                    ...
                                                                    <?php echo e(html()->form('POST', route('fees.fees-type-delete'))->open()); ?>

                                                                    <input type="hidden" name="id"
                                                                        value="<?php echo e($feesType->id); ?>">
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/gsistiww/public_html/portal/Modules/Fees/Resources/views/feesType.blade.php ENDPATH**/ ?>