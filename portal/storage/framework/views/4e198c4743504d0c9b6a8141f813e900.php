...
<?php $__env->startSection('mainContent'); ?>
    ...
    <section class="admin-visitor-area up_admin_visitor">
        <?php echo e(html()->form('POST', route('staffStore'))->attributes([
                                                ...
                                                <div class="form-section">
                                                    <div class="row mb-20">
                                                        <div class="col-lg-6 col-xl-3 mb-20">
                                                            <div class="primary_input">
                                                                ...
                                                                <input
                                                                    ...
                                                                    value="<?php echo e(old('bank_account_name')); ?>">
                                                        ...
                                                        <div class="col-lg-6 col-xl-3 mb-20">
                                                            <div class="primary_input">
                                                                <label class="primary_input_label"
                                                                    for=""><?php echo app('translator')->get('accounts.branch_name'); ?>
                                                                ...
                                                                <input
                                                                    ...
                                                                    value="<?php echo e(old('bank_brach')); ?>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-6 col-xl-3 mb-20">
                                                            <div class="primary_input">
                                                                ...
                                                                <input
                                                                    ...
                                                                    value=<?php echo e(old('facebook_url')); ?>>
                                                        ...
                                                        <div class="col-lg-6 col-xl-3 mb-20">
                                                            <div class="primary_input">
                                                                ...
                                                                <input
                                                                    ...
                                                                    value="<?php echo e(old('twiteer_url')); ?>">
                                                        ...
                                                        <div class="col-lg-6 col-xl-3 mb-20">
                                                            <div class="primary_input">
                                                                ...
                                                                <input
                                                                    ...
                                                                    value="<?php echo e(old('instragram_url')); ?>">
                                                ...
                                                <div class="form-section">
                                                    <div class="row mb-20">
                                                        <div class="col-lg-4">
                                                            ...
                                                            <div class="primary_input">
                                                                <label class="primary_input_label"
                                                                    for=""><?php echo app('translator')->get('hr.resume'); ?>
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <div class="primary_input">
                                                                <label class="primary_input_label"
                                                                    for=""><?php echo app('translator')->get('hr.joining_letter'); ?>
                                                        ...
                                                        <div class="col-lg-4">
                                                            <label class="primary_input_label"
                                                                for=""><?php echo app('translator')->get('hr.other_documents'); ?>
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/gsistiww/public_html/portal/resources/views/backEnd/humanResource/addStaff.blade.php ENDPATH**/ ?>