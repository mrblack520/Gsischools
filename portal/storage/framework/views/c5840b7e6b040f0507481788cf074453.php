            ...
            <div class="row">
                <div class="col-lg-4 col-xl-3">
                    <div class="row">
                        <div class="col-lg-12">
                            <?php if(isset($complaint)): ?>
                                <?php echo html()->form('put', url('complaint/' . @$complaint->id))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->open(); ?>

                            <?php else: ?>
                                <?php if(userPermission('complaint_store')): ?>
                                    <?php echo html()->form('POST', url('complaint'))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->open(); ?>
                                    ...
                                    <div class="row no-gutters input-right-icon">
                                        <div class="col">
                                            <div class="primary_input">
                                                ...
                                                <input class="primary_input_field" id="apply_date" type="text"
                                                    name="complaint_by"
                                    ...
                                    <div class="row mt-15">
                                        <div class="col-lg-12">
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('admin.complaint_type'); ?>
                                                <span class="text-danger"> *</span></label>
                                            <select class="primary_select" name="complaint_type">
                                    ...
                                    <div class="row mt-15">
                                        <div class="col-lg-12">
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('admin.complaint_source'); ?>
                                                <span class="text-danger"> *</span></label>
                                            <select class="primary_select" name="complaint_source">
                                    ...
                                    <div class="row mt-15">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <input oninput="phoneCheck(this)" class="primary_input_field"
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label"
                                                    for=""><?php echo app('translator')->get('admin.date'); ?><span class="text-danger"> *</span></label>
...
<?php $component->withAttributes([]); ?>
                                        <table id="table_id" class="table data-table Crm_table_active3" cellspacing="0"
                                            width="100%">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mt-40 d-flex justify-content-between">
                            <button type="button" class="primary-btn tr-bg" data-dismiss="modal"><?php echo app('translator')->get('common.cancel'); ?>
                            </button>
                            <?php echo html()->form('POST', route('complaint_delete'))->attribute('enctype', 'multipart/form-data')->open(); ?>
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/gsistiww/public_html/portal/resources/views/backEnd/admin/complaint.blade.php ENDPATH**/ ?>