...
<?php $__env->startSection('mainContent'); ?>
    ...
    <section class="admin-visitor-area up_admin_visitor">
        <div class="container-fluid p-0">
            ...
            <?php endif; ?>
            <div class="row">
                <?php if(userPermission('setup-admin-store') || isset($admin_setup)): ?>
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            <?php if(isset($admin_setup)): ?>
                                <?php echo e(html()->form('PUT', route('setup-admin-update', @$admin_setup->id))->attribute('class', 'form-horizontal')->attribute('files', true)->open()); ?>

                            <?php else: ?>
                                <?php if(userPermission('setup-admin-store')): ?>
                                    <?php echo e(html()->form('POST', route('setup-admin-store'))->attribute('class', 'form-horizontal')->attribute('files', true)->open()); ?>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for=""><?php echo app('translator')->get('common.description'); ?>
                                                    <span></span></label>
                                                <textarea class="primary_input_field form-control" cols="0" rows="4" name="description"><?php echo e(isset($admin_setup) ? $admin_setup->description : ''); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <?php
                ...
                <?php endif; ?>
                <div class="<?php if(userPermission('setup-admin-store') || isset($admin_setup)): ?> col-lg-9 <?php else: ?> col-lg-12 <?php endif; ?>">
                    <div class="white-box">
                        <div class="row">
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/gsistiww/public_html/portal/resources/views/backEnd/admin/setup_admin.blade.php ENDPATH**/ ?>