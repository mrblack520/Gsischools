                ...
                <div class="col-lg-9 student-details up_admin_visitor">
                    <div class="white-box">
                        ...
                        <div class="tab-content">
                            ...
                            <!-- Start Profile Tab -->
                            <?php echo $__env->make('backEnd.studentInformation.inc._profile_tab', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <!-- End Profile Tab -->
    
                            <!-- Start Fees Tab -->
                            <?php echo $__env->make('backEnd.studentInformation.inc._fees_tab', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <!-- End Fees Tab -->
    
                            <!-- Start leave Tab -->
                            <?php echo $__env->make('backEnd.studentInformation.inc._leave_tab', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <!-- End leave Tab -->
    
                            <!-- Start Exam Tab -->
                            <?php echo $__env->make('backEnd.studentInformation.inc._exam_tab', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <!-- End Exam Tab -->
                            ...
                            <!-- Start Documents Tab -->
                            <?php echo $__env->make('backEnd.studentInformation.inc._document_tab', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <!-- End Documents Tab -->
                            ...
                            <?php echo $__env->make('backEnd.studentInformation.inc._student_attendance_tab', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <!-- End Attendance Tab -->
    
                            <!-- Start Attendance Tab -->
                            <?php echo $__env->make('backEnd.studentInformation.inc._subject_attendance_tab', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <!-- End Attendance Tab -->
                                ...
                                <div role="tabpanel"
                                    ...
                                    <div class="white-box">
                                        <?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if ($__env->exists('backEnd.studentInformation.inc.finalMarkSheet')) echo $__env->make('backEnd.studentInformation.inc.finalMarkSheet', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
                            <?php endif; ?>
                            <?php if(moduleStatusCheck('University')): ?>
                                <div role="tabpanel" class="tab-pane fade <?php echo e($type == 'assign_subject' ? ' active show' : ''); ?>" id="studentSubject">
                                    <?php echo $__env->make('backEnd.studentInformation.inc.subject_list', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                </div>
                            <?php endif; ?>
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/gsistiww/public_html/portal/resources/views/backEnd/studentInformation/student_view.blade.php ENDPATH**/ ?>