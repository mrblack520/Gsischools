            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="white-box">
                        ...
                        <?php echo e(html()->form('POST', route('staff-attendance-search'))->attributes([
                ...
                <div class="row mt-40">
                    <div class="col-lg-12">
                        <div class="white-box">
                            ...
                            <?php echo e(html()->form('POST', route('staff-attendance-store'))->attributes([
                                    'class' => 'form-horizontal',
                                    'files' => true,
                                    'enctype' => 'multipart/form-data',
                                ])->open()); ?>
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/gsistiww/public_html/portal/resources/views/backEnd/humanResource/staff_attendance.blade.php ENDPATH**/ ?>