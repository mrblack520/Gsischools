                ...
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <?php echo e(html()->form('POST', route('language_update'))->attributes([
                            ...
                            <?php else: ?>
                                ...
                                <?php echo e(html()->form('POST', route('language_store'))->attributes([
                                    'class' => 'form-horizontal',
                                    'files' => true,
                                    'enctype' => 'multipart/form-data',
                                ])->open()); ?>
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/gsistiww/public_html/portal/resources/views/backEnd/systemSettings/language.blade.php ENDPATH**/ ?>