...
<?php $__env->startSection('mainContent'); ?>
    ...
    <section class="admin-visitor-area">
        <div class="container-fluid p-0">
            ...
            <?php else: ?>
            <?php echo e(html()->form('POST', route('staffUpdate'))->attributes([
                    'class' => 'form-horizontal',
                    'files' => true,
                    'enctype' => 'multipart/form-data',
                ])->open()); ?>
                                                            ...
                                                            <?php if(in_array('current_address', $has_permission)): ?>
                                                                <div class="col-lg-6 mb-20">
                                                                    <div class="primary_input">
                                                                        ...
                                                                        <textarea class="primary_input_field form-control" cols="0" rows="4" name="current_address" id="current_address"> <?php if(isset($editData)): ?><?php echo e($editData->current_address); ?><?php endif; ?></textarea>
                                                            ...
                                                            <?php if(in_array('permanent_address', $has_permission)): ?>
                                                                <div class="col-lg-6 mb-20">
                                                                    <div class="primary_input">
                                                                        ...
                                                                        <textarea class="primary_input_field form-control" cols="0" rows="4" name="permanent_address" id="permanent_address"><?php if(isset($editData)): ?><?php echo e($editData->permanent_address); ?><?php endif; ?> </textarea>
                                                            ...
                                                            <?php if(in_array('qualifications', $has_permission)): ?>
                                                                <div class="col-lg-6 mb-20">
                                                                    <div class="primary_input">
                                                                        ...
                                                                        <textarea class="primary_input_field form-control" cols="0" rows="4" name="qualification" id="qualification"><?php if(isset($editData)): ?><?php echo e($editData->qualification); ?><?php endif; ?> </textarea>
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/gsistiww/public_html/portal/resources/views/backEnd/humanResource/editStaff.blade.php ENDPATH**/ ?>