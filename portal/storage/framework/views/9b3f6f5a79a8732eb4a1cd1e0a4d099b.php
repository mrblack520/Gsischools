...
<style>
    ...
    <section class="admin-visitor-area up_admin_visitor">
        <div class="container-fluid p-0">
            <?php echo e(html()->form('POST', route('student-list-search'))->attributes([
            ...
            <input type="hidden" id="section" value="<?php echo e(@$section_id); ?>">
            <input type="hidden" id="shift_id" value="<?php echo e(@$shift_id); ?>">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-40 d-flex justify-content-between">
                        ...
                        <?php echo e(html()->form('POST', route('student-delete'))->attributes([
                                'enctype' => 'multipart/form-data',
                            ])->open()); ?>
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/gsistiww/public_html/portal/resources/views/backEnd/studentInformation/student_details.blade.php ENDPATH**/ ?>