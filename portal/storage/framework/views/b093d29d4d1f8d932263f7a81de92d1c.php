                    ...
                    <div class="single-video-item">
                        <a href='https://www.youtube.com/watch?v=<?php echo e($variable); ?>' class="gallery_item video">
                            ...
                            <div class="gallery_item_inner">
                                <h4 class="gallery_item_title"><?php echo e(mb_strimwidth($videoGallery->name, 0, 50, '...')); ?></h4>
                                <p class="gallery_item_desc"><?php echo e(mb_strimwidth($videoGallery->description, 0, 150, '...')); ?></p>
                            </div>
                        </a>
                    </div>
                </div>
...
<?php /**PATH /home/gsistiww/public_html/portal/resources/views/components/edulia/video-gallery.blade.php ENDPATH**/ ?>