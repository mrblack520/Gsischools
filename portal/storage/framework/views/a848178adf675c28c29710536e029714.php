                ...
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <?php echo e(html()->form('POST', url('versionUpdateInstall'))->attributes([
                                        ...
                                        <table style="width:100%; box-shadow: none;" class="table school-table-style">
                                            ...
                                            <tr>
                                                ...
                                                <?php if(! Illuminate\Support\Facades\Config::get('app.app_sync')): ?>
                                                     <?php if ($__env->exists('service::license.revoke')) echo $__env->make('service::license.revoke', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                                 <?php endif; ?> 
                                                 </td>
                                            </tr>
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/gsistiww/public_html/portal/resources/views/backEnd/systemSettings/updateSettings.blade.php ENDPATH**/ ?>