            ...
            <div class="white-box">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div>
                            <?php echo e(html()->form('GET', route('class_routine_new'))->attribute('class', 'form-horizontal')->attribute('enctype', 'multipart/form-data')->attribute('files', true)->attribute('id', 'search_student')->open()); ?>

                            <div class="row">
                                <?php if ($__env->exists('backEnd.shift.shift_class_section_include', [
                                ...
                                ])) echo $__env->make('backEnd.shift.shift_class_section_include', [
                                    'div'=> shiftEnable() ? 'col-lg-4' : 'col-lg-6',
                                    'mt' => '',
                                    'title' => ['class', 'shift', 'section'],
                                    'visiable' => ['shift', 'class', 'section'],
                ...
                <div class="white-box">
                    <div class="row">
                        ...
                        <div class="col-lg-6 pull-right">
                            <a href="<?php echo e(route('classRoutinePrint', [$class_id, $section_id, $shift_id])); ?>"
                    ...
                    <div class="row">
                        <div class="col-lg-12 student-details up_admin_visitor mt-0">
                            <ul class="nav nav-tabs tabs_scroll_nav mb-4 mt-2" role="tablist" id="tabs_ul">
                                ...
                                <input type="hidden" name="routine_shift_id" id="routine_shift_id"
        ...
        <?php if(isset($sm_weekends)): ?>
            <script>
                ...
                function addDayData(day_id) {
                    ...
                    var shift_id = $('#routine_shift_id').val();
                ...
                <div class="row " id="teacher-div">
                    <div class="col-lg-12">
                        <select class="primary_select  form-control selectTeacher" data-teacher_row_id="${row_count}" name="routine[${row_count}][teacher_id]"  id="teacher_${row_count}">
                            <option data-display="<?php echo app('translator')->get('academics.academics'); ?>" value=""><?php echo app('translator')->get('academics.class_routine_create'); ?> </option>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <select class="primary_select  form-control selectRoom" data-room_row_id = "${row_count}" id="room_${row_count}" name="routine[${row_count}][room]">
                            <option data-display="<?php echo app('translator')->get('common.select_criteria'); ?>" value=""><?php echo app('translator')->get('common.select_class'); ?></option>
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/gsistiww/public_html/portal/resources/views/backEnd/academics/class_routine_new.blade.php ENDPATH**/ ?>