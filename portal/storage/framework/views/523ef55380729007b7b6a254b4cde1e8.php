            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <?php echo e(html()->form('POST', route('login-access-control-search'))->attributes([
                                            ...
                                            <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr id="<?php echo e(@$student->user_id); ?>">
                                                    ...
                                                    <td style="white-space: nowrap;">
                                                        <?php echo e(html()->form('POST', route('reset-student-password'))->attributes([
                                                            'class' => 'form-horizontal',
                                                            'files' => true,
                                                            'enctype' => 'multipart/form-data',
                                                        ])->open()); ?>
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/gsistiww/public_html/portal/resources/views/backEnd/systemSettings/login_access_control.blade.php ENDPATH**/ ?>