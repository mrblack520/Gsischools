...
<?php $__env->startSection('mainContent'); ?>
    ...
    <section class="admin-visitor-area up_st_admin_visitor">
        <div class="container-fluid p-0">
            <?php if(isset($invoiceInfo)): ?>
                <?php echo e(html()->form('POST', route('fees.fees-invoice-update'))->attributes(['class' => 'form-horizontal'])->open()); ?>

                <input type="hidden" name="id" class="editValue" value="<?php echo e($invoiceInfo->id); ?>">
            <?php else: ?>
                <?php echo e(html()->form('POST', route('fees.fees-invoice-store'))->attributes(['class' => 'form-horizontal'])->open()); ?>
                            ...
                            <div class="white-box">
                                ...
                                <div class="add-visitor">
                                    <div class="row">
                                        <div class="col-lg-12 d-flex">
                                            ...
                                            <input type="hidden" id="fees_invoice_prefix"
                                                value="<?php echo e(@$invoiceSettings->prefix); ?>">
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 mt-15" id="select_un_student_div">
                                                ...
                                                <?php echo e(html()->select(
                                                        'student_id',
                                                        @$students ?? ['' => __('common.select_student') . '*'],
                                                        isset($invoiceInfo) ? $invoiceInfo->student_id : null,
                                                    )->attributes([
                                                        'class' => 'primary_select form-control' . ($errors->has('student_id') ? ' is-invalid' : ''),
                                                        'id' => 'select_un_student',
                                                        isset($invoiceInfo) ? 'disabled' : '',
                                                    ])); ?>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <div class="row">
                                            <?php if ($__env->exists('backEnd.shift.shift_include', [
                                                ...
                                                'required' => true,
                                                'editData' => isset($shift_id)? $shift_id: null,
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 mt-30-md" id="id-card-div">
                                                <label for="class"> <?php echo e(__('common.class')); ?> <span
                                        ...
                                        <div class="row mt-15">
                                            <div class="col-lg-12" id="selectStudentDiv">
                                                    ...
                                                    <?php if(isset($invoiceInfo)): ?>
                                                        <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($student->id); ?>"
                                                                <?php echo e($student->id == $invoiceInfo->record_id ? 'selected' : ''); ?>>
                                                ...
                                                <div class="pull-right loader" id="selectStudentLoader"
                                                    style="margin-top: -30px;padding-right: 21px;">
                                                    <img src="<?php echo e(asset('Modules/Fees/Resources/assets/img/pre-loader.gif')); ?>"
                                    ...
                                    <div class="row mt-15">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for=""><?php echo app('translator')->get('fees.create_date'); ?> <span
                                                        class="text-danger"> *</span></label>
                                                <div class="primary_datepicker_input">
                                                    <div class="no-gutters input-right-icon">
                                                        <div class="col">
                                                            <div class="">
                                                                <input
                                                                    class="primary_input_field  primary_input_field date form-control form-control<?php echo e($errors->has('create_date') ? ' is-invalid' : ''); ?>"
                                                                    id="create_date" type="text" name="create_date"
                                                                    value="<?php echo e(isset($invoiceInfo) ? date('m/d/Y', strtotime($invoiceInfo->create_date)) : date('m/d/Y')); ?>">
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="row mt-15">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for=""><?php echo app('translator')->get('fees.due_date'); ?> <span
                                                        class="text-danger"> *</span></label>
                                                <div class="primary_datepicker_input">
                                                    <div class="no-gutters input-right-icon">
                                                        <div class="col">
                                                            <div class="">
                                                                <input
                                                                    ...
                                                                    value="<?php echo e(isset($invoiceInfo) ? date('m/d/Y', strtotime($invoiceInfo->due_date)) : date('m/d/Y')); ?>">
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="row mt-15 <?php echo e(isset($invoiceInfo) ? 'd-none' : ''); ?>">
                                        <div class="col-lg-12">
                                            ...
                                            <select
                                                class="primary_select  form-control<?php echo e($errors->has('payment_status') ? ' is-invalid' : ''); ?>"
                                                name="payment_status" id="paymentStatus">
                                                <option data-display="<?php echo app('translator')->get('fees.payment_status'); ?> *" value="">
                                                    <?php echo app('translator')->get('fees.payment_status'); ?> *</option>
                                                <option value="not"
                                                    <?php echo e(isset($invoiceInfo) ? ($invoiceInfo->payment_status == 'not' ? 'selected' : '') : (old('payment_status') == 'not' ? 'selected' : '')); ?>>
                                                    <?php echo app('translator')->get('fees.not_paid'); ?></option>
                                                <option value="partial"
                                                    <?php echo e(isset($invoiceInfo) ? ($invoiceInfo->payment_status == 'partial' ? 'selected' : '') : (old('payment_status') == 'partial' ? 'selected' : '')); ?>>
                                                    <?php echo app('translator')->get('fees.partial_paid'); ?></option>
                                                <option value="full"
                                                    <?php echo e(isset($invoiceInfo) ? ($invoiceInfo->payment_status == 'full' ? 'selected' : '') : (old('payment_status') == 'full' ? 'selected' : '')); ?>>
                                                    <?php echo app('translator')->get('fees.full_paid'); ?></option>
                                            </select>
                                    ...
                                    <div class="row mt-15 d-none" id="paymentMethod">
                                        <div class="col-lg-12">
                                            ...
                                            <select
                                                ...
                                                <option data-display="<?php echo app('translator')->get('fees.payment_method'); ?>*" value="">
                                                    <?php echo app('translator')->get('fees.payment_method'); ?>*</option>
                                                <?php $__currentLoopData = $paymentMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paymentMethod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($paymentMethod->method); ?>"
                                                        <?php echo e(isset($invoiceInfo) ? ($invoiceInfo->payment_method == $paymentMethod->method ? 'selected' : '') : (old('payment_method') == $paymentMethod->method ? 'selected' : '')); ?>>
                                    ...
                                    <div class="row mt-15 d-none" id="bankPayment">
                                        <div class="col-lg-12">
                                            ...
                                            <select
                                                ...
                                                name="bank">
                                                <option data-display="<?php echo app('translator')->get('fees.select_bank'); ?>*" value="">
                                                    <?php echo app('translator')->get('fees.select_bank'); ?>*</option>
                                                <?php $__currentLoopData = $bankAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bankAccount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($bankAccount->id); ?>"
                                                        <?php echo e(isset($invoiceInfo) ? ($invoiceInfo->bank_id == $bankAccount->id ? 'selected' : '') : (old('bank') == $bankAccount->id ? 'selected' : '')); ?>>
                                                        <?php echo e($bankAccount->bank_name); ?> (<?php echo e($bankAccount->account_number); ?>)
                                                    </option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                    ...
                                    <div class="row mt-40">
                                        <div class="col-lg-12 text-center">
                                            <button type="submit" class="primary-btn fix-gr-bg submit fmInvoice"
                                                data-tooltip="tooltip" title="<?php echo e($tooltip); ?>">
                    ...
                    <div class="white-box">
                        ...
                        <div class="row mt-15">
                            <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-12">
                                            <select
                                                ...
                                                <option data-display="<?php echo app('translator')->get('fees.fees_type'); ?> *" value="">
                                                    <?php echo app('translator')->get('fees.fees_type'); ?> *</option>
                                                ...
                                                <?php $__currentLoopData = $feesGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feesGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="grp<?php echo e($feesGroup->id); ?>"><?php echo e($feesGroup->name); ?>
                                    ...
                                    <div class="row mt-20">
                                        <div class="col-lg-12 justify-content-end d-flex">
                                            <div class="text-right">
                                                <input type="checkbox" name="singleInvoice" id="singleInvoice"
                                                    class="common-checkbox form-control" value="1">
                                ...
                                <div class="big-table">
                                    <table class="table school-table-style fees_invoice_type_table" cellspacing="0"
                                        width="100%">
                                        <thead>
                                            <tr>
                                            ...
                                            <?php if(isset($invoiceInfo)): ?>
                                                <?php $__currentLoopData = $invoiceDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $invoiceDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <input type="hidden" name="feesType[]"
                                                            value="<?php echo e($invoiceDetail->fees_type); ?>">
                                                        <td>
                                                            <div class="primary_input">
                                                                <input
                                                                    class="primary_input_field form-control amount<?php echo e($errors->has('amount') ? ' is-invalid' : ''); ?>"
                                                        ...
                                                        <td>
                                                            <div class="primary_input">
                                                                <input
                                                                    class="primary_input_field form-control weaver<?php echo e($errors->has('weaver') ? ' is-invalid' : ''); ?>"
                                                        ...
                                                        <td class="subTotal">
                                                            <?php echo e(isset($invoiceDetail) ? $invoiceDetail->sub_total : ''); ?>

                                                        </td>
                                                        <input type="hidden" name="sub_total[]" class="inputSubTotal"
                                                            value="<?php echo e(isset($invoiceDetail) ? $invoiceDetail->sub_total : ''); ?>">
                                                        <?php if(!isset($invoiceDetail)): ?>
                                                            <td>
                                                                <input
                                                                    class="primary_input_field form-control paidAmount<?php echo e($errors->has('paid_amount') ? ' is-invalid' : ''); ?>"
                                                                    type="number" name="paid_amount[]"
                                                                    autocomplete="off" disabled
                                                                    value="<?php echo e(isset($invoiceDetail) ? $invoiceDetail->paid_amount : old('paid_amount')); ?>">
                                                            </td>
                                                        <?php endif; ?>
                                                        <td>
                                                            <button class="primary-btn icon-only fix-gr-bg"
                                                                ...
                                                                type="button" title="<?php echo app('translator')->get('common.edit_note'); ?>">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <div class="primary_input">
                                                                                <input
                                                                                    ...
                                                                                    type="text" name="note[]"
                                                                                    autocomplete="off"
                                                                                    value="<?php echo e(isset($invoiceDetail) ? $invoiceDetail->note : ''); ?>">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <button type="button"
                                                                                    ...
                                                                                    data-dismiss="modal"><?php echo app('translator')->get('common.update'); ?></button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <input type="hidden" class="fees"
                                                                value="grp<?php echo e($invoiceDetail->feesType->fees_group_id); ?>">
                                                            <input type="hidden" class="fees"
                                                                value="typ<?php echo e($invoiceDetail->fees_type); ?>">
                                                        </td>
                                                    </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php endif; ?>
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/gsistiww/public_html/portal/Modules/Fees/Resources/views/feesInvoice/feesInvoice.blade.php ENDPATH**/ ?>