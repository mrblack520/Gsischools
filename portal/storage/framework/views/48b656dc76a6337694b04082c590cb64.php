        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 offset-lg-1 col-md-6">
                <div class="about_us_inner about_us_home">
                    ...
                    <?php endif; ?>
                    <?php if(!empty(pagesetting('home_about_area_phone'))): ?>
                    <div class="about_us_inner_call">
                        <a href="tel:<?php echo e(pagesetting('home_about_area_phone')); ?>">
...
<?php /**PATH /home/gsistiww/public_html/portal/resources/views/themes/edulia/pagebuilder/home-about-area/view.blade.php ENDPATH**/ ?>