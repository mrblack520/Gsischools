                                                                                ...
                                                                                <div class="modal-dialog modal-dialog-centered">
                                                                                    <div class="modal-content">
                                                                                        ...
                                                                                        <div class="modal-body text-left">
                                                                                            <?php echo html()->form('POST', route('ManageAddOnsValidation'))->attributes([
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            <?php echo e(html()->form('POST', route('moduleFileUpload'))->attributes([
                                'class' => 'form-horizontal',
                                'files' => true,
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/gsistiww/public_html/portal/resources/views/backEnd/systemSettings/ManageAddOns.blade.php ENDPATH**/ ?>