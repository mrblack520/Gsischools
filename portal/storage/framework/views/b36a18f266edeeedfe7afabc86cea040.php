        ...
        <tr>
            ...
            <td>
                <div class="primary_input">
                    <input class="primary_input_field form-control amount<?php echo e($errors->has('amount') ? ' is-invalid' : ''); ?>" min="0"  type="number" step="0.01" name="groups[<?php echo e($key); ?>][amount]" autocomplete="off" value="<?php echo e(old('amount')); ?>">
            ...
            <td>
                <div class="primary_input">
                    <input class="primary_input_field form-control weaver<?php echo e($errors->has('weaver') ? ' is-invalid' : ''); ?>" min="0"  type="number" step="0.01" name="groups[<?php echo e($key); ?>][weaver]" autocomplete="off" value="<?php echo e(old('weaver')); ?>">
            ...
            <?php if(!isset($editData)): ?>
                <td>
                    <input class="primary_input_field form-control paidAmount<?php echo e($errors->has('paid_amount') ? ' is-invalid' : ''); ?>" type="number" min="0"  step="0.01" name="groups[<?php echo e($key); ?>][paid_amount]" autocomplete="off" disabled>
                </td>
            <?php endif; ?>
            <td>
...
<?php if(isset($feesType)): ?>
    <tr>
        ...
        <td>
            <div class="primary_input">
                <input class="primary_input_field form-control amount<?php echo e($errors->has('amount') ? ' is-invalid' : ''); ?>" min="0" step="0.01"  type="number" name="types[<?php echo e($feesType->id); ?>][amount]" autocomplete="off" value="<?php echo e(old('amount')); ?>">
        ...
        <td>
            <div class="primary_input">
                <input class="primary_input_field form-control weaver<?php echo e($errors->has('weaver') ? ' is-invalid' : ''); ?>" min="0" step="0.01"   type="number" name="types[<?php echo e($feesType->id); ?>][weaver]" autocomplete="off" value="<?php echo e(old('weaver')); ?>">
        ...
        <?php if(!isset($editData)): ?>
            <td>
                <input class="primary_input_field form-control paidAmount<?php echo e($errors->has('paid_amount') ? ' is-invalid' : ''); ?>" min="0"  step="0.01" type="number"  name="types[<?php echo e($feesType->id); ?>][paid_amount]" autocomplete="off" disabled>
            </td>
        <?php endif; ?>
        <td>
...
<?php endif; ?>
<?php /**PATH /home/gsistiww/public_html/portal/Modules/Fees/Resources/views/_allFeesType.blade.php ENDPATH**/ ?>