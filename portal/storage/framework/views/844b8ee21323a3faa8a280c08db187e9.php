    ...
    <section class="admin-visitor-area">
        <div class="container-fluid p-0">
            <?php if(userPermission('saveHomeworkData')): ?>
                <?php echo e(html()->form('POST', route('saveHomeworkData'))->attributes([
                                ...
                                <div class="col-lg-12">
                                    <div class="primary_input ">
                                        <label class="primary_input_label" for=""><?php echo app('translator')->get('common.description'); ?> <span
                                                class="text-danger"> *</span> </label>
                                        <textarea class="primary_input_field form-control<?php echo e($errors->has('description') ? ' is-invalid' : ''); ?>"
                                            cols="0" rows="4" name="description" id="description *"><?php echo e(old('description')); ?></textarea>
                                    ...
                                    <label class="primary_input_label" for=""><?php echo app('translator')->get('homework.attach_file'); ?></label>
                                    	<div class="dropzone" id="fileDropZone">
                                            <div class="dropzone-placeholder">
                                                ...
                                                <h5>Browse File</h5>
                                                <p> Or Drag & Drop File Here (<?php echo e(generalSetting()->file_size / 1024); ?> Mb max file size)</p>
                                            </div>
                                        </div>
...
<?php $__env->startPush('script'); ?>
    <script src="<?php echo e(asset('public/backEnd/dropzone/dropzone.min.js')); ?>"></script>
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/gsistiww/public_html/portal/resources/views/backEnd/homework/addHomework.blade.php ENDPATH**/ ?>