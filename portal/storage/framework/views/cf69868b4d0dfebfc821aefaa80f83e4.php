                        ...
                        <div class="col-lg-5">
                            <div class="name">
                                <?php if(isset($ContentDetails)): ?>
                                    ...
                                    <?php endif; ?>
                                    <?php if($ContentDetails->shift != ""): ?>
                                        <p><?php echo app('translator')->get('common.shift'); ?> : <?php echo e(@$ContentDetails->shift->name); ?></p>
                                    <?php endif; ?>
                                <?php endif; ?>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        <div class="name">
                            ...
                            <a class="dropdown-item viewSubmitedHomework attachment" id="show_files" href="#"> <span class="pl ti-download"></span></a>
...
<script type="text/javascript">
  ...
  </script><?php /**PATH /home/gsistiww/public_html/portal/resources/views/backEnd/teacher/uploadContentDetails.blade.php ENDPATH**/ ?>