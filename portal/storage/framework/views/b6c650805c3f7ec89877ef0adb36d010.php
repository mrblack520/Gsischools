            ...
            <div class="header_iner d-flex justify-content-between align-items-center">
                ...
                <div class="header_right d-flex justify-content-between align-items-center">
                    ...
                    <?php if(moduleStatusCheck('AiContent')): ?>
                        <?php echo $__env->make('aicontent::inc.menu_btn', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <?php endif; ?>
                    ...
                    <ul class="header_notification_warp d-flex align-items-center">
                        ...
                        <?php if(!generalSetting()->chatting_method  || generalSetting()->chatting_method == 'log'): ?>
...
<?php /**PATH /home/gsistiww/public_html/portal/resources/views/backEnd/partials/menu.blade.php ENDPATH**/ ?>