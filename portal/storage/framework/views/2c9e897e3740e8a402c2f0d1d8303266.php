...
<?php $__env->startSection('mainContent'); ?>
    ...
    <?php
        $breadCrumbs = [
            ...
            'bcPages' => ['<a href="#">' . __('student.student_information') . '</a>'],
        ];
    ?>
...
<?php endif; ?>
    <section class="admin-visitor-area up_st_admin_visitor">
        <div class="container-fluid p-0">
            ...
            <?php endif; ?>
            <div class="row">
                <?php if(userPermission('student_category_store') || isset($student_type)): ?>
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">

                            <?php if(isset($student_type)): ?>
                                <?php echo e(html()->form('POST', route('student_category_update'))->attributes(['class' => 'form-horizontal'])->open()); ?>

                            <?php else: ?>
                                <?php if(userPermission('student_category_store')): ?>
                                    <?php echo e(html()->form('POST', route('student_category_store'))->attributes(['class' => 'form-horizontal'])->open()); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="primary_input">
                                                ...
                                                <input
                                                    class="primary_input_field form-control<?php echo e($errors->has('category') ? ' is-invalid' : ''); ?>"
                                                    type="text" name="category" autocomplete="off"
                                                    value="<?php echo e(isset($student_type) ? $student_type->category_name : ''); ?>">
                                                <input type="hidden" name="id"
                                                    value="<?php echo e(isset($student_type) ? $student_type->id : ''); ?>">
                ...
                <?php endif; ?>
                <div class="<?php if(userPermission('student_category_store') || isset($student_type)): ?> col-lg-9 <?php else: ?> col-lg-12 <?php endif; ?>">
                    <div class="white-box">
                        <div class="row">
                                                        ...
                                                        <?php
                                                            $routeList = [
                                                                ...
                                                                userPermission('student_category_delete')
                                                                    ? '<a class="dropdown-item" data-toggle="modal" data-target="#deleteStudentTypeModal' .
                                                                        $student_type->id .
                                                                        '"
                                                                href="#">' .
                                                                        __('common.delete') .
...
<?php endif; ?>
                                                ...
                                                <div class="modal fade admin-query"
                                                    id="deleteStudentTypeModal<?php echo e($student_type->id); ?>">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mt-40 d-flex justify-content-between">
                                                                    ...
                                                                    <a
                                                                        href="<?php echo e(route('student_category_delete', [$student_type->id])); ?>"><button
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/gsistiww/public_html/portal/resources/views/backEnd/studentInformation/student_category.blade.php ENDPATH**/ ?>