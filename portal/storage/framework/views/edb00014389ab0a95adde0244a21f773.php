...
<div id="vertical" class="d-none" style="margin: 0; padding: 0; font-family: 'Poppins', sans-serif; font-weight: 500;  font-size: 12px; line-height:1.02 ; color: #000">
    <div class="horizontal__card vr_bg" style="line-height:1.02; background-image: url(<?php echo e(asset('public/backEnd/id_card/img/vertical_bg.png')); ?>); width: 57.15mm; height: 88.9mm; margin: auto; background-size: 100% 100%; background-position: center center; position: relative; background-color: #fff; display: flex; flex-direction: column;">
        ...
        <div class="horizontal_card_body" style="line-height:1.02; display:flex; padding-top:2.5mm ; padding-bottom: 2.5mm ; padding-right: 3mm ; padding-left: 3mm ; flex-direction: column; padding-top: 0;">
            ...
            <?php if(moduleStatusCheck('QRCodeAttendance')): ?>          
                <div class="card_qr_code" style="border: 2px solid #6D36E9; width: 130px; height: 130px; aspect-ratio: 1/1; margin: auto; padding: 2px; margin-top: -8px">
                    <img src="<?php echo e(asset('public/demo-qrcode.png')); ?>" style="width: 100%; height: 100%; aspect-ratio: 1/1; object-fit: cover; object-position: center center;" alt="qr code">
                </div>      
            <?php else: ?>    
...
</div><?php /**PATH /home/gsistiww/public_html/portal/resources/views/backEnd/admin/idCard/add_view_id_card.blade.php ENDPATH**/ ?>