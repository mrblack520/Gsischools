                    ...
                    <div class="white-box">
                        ...
                        <div class="student-meta-box">
                            ...
                            <div class="white-box">
                                ...
                                <?php if(moduleStatusCheck('QRCodeAttendance') && file_exists(public_path('qr_codes/staff-'.$staffDetails->id.'-qrcode.png'))): ?>
                                <div class="single-meta">
                                    <div class="d-flex justify-content-between">
                                        <div class="name">
                                            <?php echo app('translator')->get('qrcodeattendance::qr_code_attendance.qr_code'); ?>
                                        </div>
                                        <div class="value">
                                            <img height="100" width="100" src="<?php echo e(asset('public/qr_codes/staff-'.$staffDetails->id.'-qrcode.png')); ?>" alt="">
                                        </div>
                                    </div>
                                </div>
                                <?php endif; ?>
                            ...
                            <div class="modal fade admin-query" id="add_document_madal">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="container-fluid">
                                                <?php echo e(html()->form('POST', route('save_upload_document'))->attributes([
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="container-fluid">
                                                ...
                                                <?php echo e(html()->form('POST', route('staff_timeline_store'))->attributes([
                                                        'class' => 'form-horizontal',
                                                        'files' => true,
                                                        'enctype' => 'multipart/form-data',
                                                        'name' => 'document_upload',
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/gsistiww/public_html/portal/resources/views/backEnd/humanResource/viewStaff.blade.php ENDPATH**/ ?>