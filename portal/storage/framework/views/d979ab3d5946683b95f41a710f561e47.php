...
<div>
    <input type="hidden" name="old_sign" value="<?php echo e(isset($id_card) ? 1:0); ?>" id="old_sign">
    <input type="hidden" name="old_logo" value="<?php echo e(isset($id_card) ? 1:0); ?>" id="old_logo">
    <input type="hidden" name="old_bg" value="<?php echo e(isset($id_card) ? 1:0); ?>" id="old_bg">
    <input type="hidden" name="old_profile" value="<?php echo e(isset($id_card) ? 1:0); ?>" id="old_profile">
    ...
    <div class="add-visitor">
            ...
            <div class="col-lg-12">
                <div class="primary_input">
                    ...
                    <select class="primary_select  form-control<?php echo e($errors->has('page_layout_style') ? ' is-invalid' : ''); ?>" name="page_layout_style" id="pageLayoutStyle">
                        <option value="horizontal" <?php echo e(isset($id_card)? ($id_card->page_layout_style == "horizontal"? 'selected':''):''); ?>><?php echo app('translator')->get('admin.horizontal'); ?></option>
                        <option value="vertical" <?php echo e(isset($id_card)? ($id_card->page_layout_style == "vertical"? 'selected':''):''); ?>><?php echo app('translator')->get('admin.vertical'); ?></option>
                    </select>
            ...
            <div class="col-lg-12">
                <div class="primary_input">
                    ...
                    <select
                        ...
                        <?php else: ?>
                            <option selected value="2"><?php echo app('translator')->get('admin.student'); ?></option>
            ...
            <div class="col-lg-8">
                <div class="primary_input">
                    <select
                        ...
                        <option value="squre"
                            <?php echo e(isset($id_card) ? ($id_card->user_photo_style == 'squre' || $id_card->user_photo_style == '' ? 'selected' : '') : ''); ?>>
        ...
        <?php if(moduleStatusCheck('University') && moduleStatusCheck('QRCodeAttendance') ==  false): ?>
        ...
        <div class="row mt-25 fatherName" style="<?php echo e(moduleStatusCheck('QRCodeAttendance') ? 'display:none;':''); ?>">
            <div class="col-lg-4 d-flex">
        ...
        <div class="row mt-25 motherName" style="<?php echo e(moduleStatusCheck('QRCodeAttendance') ? 'display:none;':''); ?>">
            <div class="col-lg-4 d-flex">
        ...
        ?>
        <div class="row mt-25 mobile  <?php echo e($is_mobile == false ? 'd-none':''); ?> ">
            <div class="col-lg-4 d-flex">
        ...
        <div class="row mt-25 dateOfBirth" style="<?php echo e(moduleStatusCheck('QRCodeAttendance') ? 'display:none':''); ?>">
            <div class="col-lg-4 d-flex">
        ...
        <div class="row mt-25 bloodGroup" style="<?php echo e(moduleStatusCheck('QRCodeAttendance') ? 'display:none':''); ?>">
            <div class="col-lg-4 d-flex">
        ...
        <div class="row mt-25 photo ">
            <div class="col-lg-4 d-flex">
                <p class="text-uppercase fw-500 mb-10"><?php echo app('translator')->get('student.photo'); ?></p>
            </div>
            <div class="col-lg-8">
                <div class="d-flex radio-btn-flex ml-40">
                    <div class="mr-30">
                        <input type="radio" name="photo" id="photo_yes" value="1"
                            ...
                            <?php echo e(isset($id_card) ? ($id_card->photo == 1 ? 'checked' : '') : 'checked'); ?>>
                        <label for="photo_yes"><?php echo app('translator')->get('admin.yes'); ?></label>
                    </div>
                    <div class="mr-30">
                        <input type="radio" name="photo" id="photo_no" value="0"
                            class="common-radio relationButton" onclick="profilePhoto('0')"
                            <?php echo e(isset($id_card) ? ($id_card->photo == 0 ? 'checked' : '') : ''); ?>>
                        <label for="photo_no"><?php echo app('translator')->get('admin.none'); ?></label>
                    </div>
                </div>
            </div>
        </div>
        ...
        <?php
            $applicableUsers = isset($id_card) ? json_decode($id_card->role_id):[];
        ?>
        <div class="row mt-25 <?php echo e(isset($id_card) && !in_array(3, $applicableUsers) && !in_array(2, $applicableUsers) ? '':'d-none'); ?>" id="staff_department">
            <div class="col-lg-4 d-flex">
                <p class="text-uppercase fw-500 mb-10"><?php echo app('translator')->get('hr.department'); ?></p>
            </div>
            <div class="col-lg-8">
                <div class="d-flex radio-btn-flex ml-40">
                    <div class="mr-30">
                        <input type="radio" name="staff_department" id="staff_dep_yes" value="1"
                            ...
                            <?php echo e(isset($id_card) ? ($id_card->staff_department == 1 ? 'checked' : '') : 'checked'); ?>>
                        <label for="staff_dep_yes"><?php echo app('translator')->get('admin.yes'); ?></label>
                    </div>
                    <div class="mr-30">
                        <input type="radio" name="staff_department" id="staff_dep_yno" value="0"
                            ...
                            <?php echo e(isset($id_card) ? ($id_card->staff_department == 0 ? 'checked' : '') : ''); ?>>
                        <label for="staff_dep_yno"><?php echo app('translator')->get('admin.none'); ?></label>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-25 <?php echo e(isset($id_card) && !in_array(3, $applicableUsers) && !in_array(2, $applicableUsers) ? '':'d-none'); ?>" id="staff_designation">
            <div class="col-lg-4 d-flex">
                <p class="text-uppercase fw-500 mb-10"><?php echo app('translator')->get('hr.designation'); ?></p>
            </div>
            <div class="col-lg-8">
                <div class="d-flex radio-btn-flex ml-40">
                    <div class="mr-30">
                        <input type="radio" name="staff_designation" id="staff_designation_yes" value="1"
                            ...
                            <?php echo e(isset($id_card) ? ($id_card->staff_designation == 1 ? 'checked' : '') : 'checked'); ?>>
                        <label for="staff_designation_yes"><?php echo app('translator')->get('admin.yes'); ?></label>
                    </div>
                    <div class="mr-30">
                        <input type="radio" name="staff_designation" id="staff_designation_no" value="0"
                            ...
                            <?php echo e(isset($id_card) ? ($id_card->staff_designation == 0 ? 'checked' : '') : ''); ?>>
                        <label for="staff_designation_no"><?php echo app('translator')->get('admin.none'); ?></label>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-25 signature">
            <div class="col-lg-4 d-flex">
                <p class="text-uppercase fw-500 mb-10"><?php echo app('translator')->get('student.signature'); ?></p>
            </div>
            <div class="col-lg-8">
                <div class="d-flex radio-btn-flex ml-40">
                    <div class="mr-30">
                        <input type="radio" name="signature_status" id="signature_yes" value="1"
                            ...
                            <?php echo e(isset($id_card) ? ($id_card->signature_status == 1 ? 'checked' : '') : 'checked'); ?>>
                        <label for="signature_yes"><?php echo app('translator')->get('admin.yes'); ?></label>
                    </div>
                    <div class="mr-30">
                        <input type="radio" name="signature_status" id="signature_no" value="0"
                            ...
                            <?php echo e(isset($id_card) ? ($id_card->signature_status == 0 ? 'checked' : '') : ''); ?>>
                        <label for="signature_no"><?php echo app('translator')->get('admin.none'); ?></label>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH /home/gsistiww/public_html/portal/resources/views/backEnd/admin/idCard/form_id_card.blade.php ENDPATH**/ ?>