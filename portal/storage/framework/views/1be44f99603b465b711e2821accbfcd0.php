            ...
            <?php $__currentLoopData = $student_records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div role="tabpanel"
                    ...
                    <?php if(generalSetting()->fees_status == 0): ?>
                        <?php if ($__env->exists('backEnd.studentPanel.inc._student_direct_fees')) echo $__env->make('backEnd.studentPanel.inc._student_direct_fees', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <?php else: ?>
...
<?php /**PATH /home/gsistiww/public_html/portal/resources/views/backEnd/studentPanel/inc/_fees_info.blade.php ENDPATH**/ ?>