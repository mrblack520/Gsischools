<style>
    ...
    table.dataTable tfoot td.walletAmount {
    ...
    <div class="modal-dialog modal-dialog-centered large-modal">
        <div class="modal-content">
            ...
            <div class="modal-body p-0 mt-30">
                <div class="container student-certificate pb-4">
                            ...
                            <div class="mb-5">
                                <?php if(isset($status) && $status == 'approve'): ?>
                                    <?php if(userPermission('wallet.approve-diposit')): ?>
                                        <a class="file" href="" download><?php echo app('translator')->get('common.download'); ?> <span
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-40 d-flex justify-content-between">
                        ...
                        <?php echo e(html()->form('POST', route('wallet.approve-payment'))->open()); ?>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <?php echo e(html()->form('POST', route('wallet.reject-payment'))->open()); ?>
        ...
        $(document).ready(function() {
            $('.data-table').DataTable({
                ...
                columns: [{
                    ...
                    <?php if(isset($status) && $status == 'reject'): ?>
                        {
                            data: 'walletRejectNote',
                            name: 'walletRejectNote',
                            orderable: false,
                            searchable: false
                        },
                    <?php endif; ?>
...
<?php /**PATH /home/gsistiww/public_html/portal/Modules/Wallet/Resources/views/_walletRequest.blade.php ENDPATH**/ ?>