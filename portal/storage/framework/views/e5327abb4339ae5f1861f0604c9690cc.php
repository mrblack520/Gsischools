...
<div role="tabpanel" class="tab-pane fade" id="studentExam">
    <?php if(moduleStatusCheck('University')): ?>
        ...
        <?php if ($__env->exists('university::exam.admin_student_exam_tab')) echo $__env->make('university::exam.admin_student_exam_tab', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php else: ?>
        <?php
                                                ...
                                                <th><?php echo app('translator')->get('exam.grade'); ?>:
                                                    <?php
                                                        if (in_array($fail_gpa_name->grade_name, $temp_grade)) {
                                                            ...
                                                            $final_gpa_point =$total_gpa_point > 0 ? ($total_gpa_point - $optional_gpa) / ($total_subject - $optional_subject):0;
                                                            $average_grade = 0;
                                                            $average_grade_max = 0;
    ...
    <?php endif; ?>
</div><?php /**PATH /home/gsistiww/public_html/portal/resources/views/backEnd/studentInformation/inc/_exam_tab.blade.php ENDPATH**/ ?>