        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        <?php if(isset($department)): ?>
                        <?php echo e(html()->form('PUT', route('department-update', $department->id))->attributes([
                        ...
                        <?php else: ?>
                         <?php if(userPermission("department-store")): ?>
                         <?php echo e(html()->form('POST', route('department-store'))->attributes([
                                'class' => 'form-horizontal',
                                'files' => true,
                                'enctype' => 'multipart/form-data',
                            ])->open()); ?>                        
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mt-40 d-flex justify-content-between">
                                                        ...
                                                        <?php echo e(html()->form('DELETE', route('department-delete', $department->id))->attribute('enctype', 'multipart/form-data')->open()); ?>
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/gsistiww/public_html/portal/resources/views/backEnd/humanResource/human_resource_department.blade.php ENDPATH**/ ?>