                ...
                <?php if(userPermission('fees_group_store')): ?>
                    <div class="row">
                        <div class="offset-lg-10 col-lg-2 text-right col-md-12 mb-20">
                            <a href="<?php echo e(route('fees.fees-group')); ?>" class="primary-btn small fix-gr-bg"><span
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            <?php if(isset($feesGroup)): ?>
                                <?php echo e(html()->form('POST', route('fees.fees-group-update'))->attributes(['class' => 'form-horizontal'])->open()); ?>

                                <input type="hidden" name="id" value="<?php echo e(isset($feesGroup) ? $feesGroup->id : ''); ?>">
                            <?php else: ?>
                                <?php echo e(html()->form('POST', route('fees.fees-group-store'))->attributes(['class' => 'form-horizontal'])->open()); ?>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <input
                                                    ...
                                                    value="<?php echo e(isset($feesGroup) ? $feesGroup->name : old('name')); ?>">
                                    ...
                                    <div class="row mt-15">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <textarea class="primary_input_field form-control" cols="0" rows="4" name="description"><?php echo e(isset($feesGroup) ? $feesGroup->description : old('description')); ?></textarea>
...
<?php $component->withAttributes([]); ?>
                                                            <?php if(userPermission('fees.fees-group-edit')): ?>
                                                                <a class="dropdown-item"
                                                                    href="<?php echo e(route('fees.fees-group-edit', [$feesGroup->id])); ?>">
                                                                    <?php echo app('translator')->get('common.edit'); ?></a>
                                                            <?php endif; ?>

                                                            <?php if(userPermission('fees.fees-group-delete')): ?>
                                                                <a class="dropdown-item deleteFeesGroupModal"
                                                                    data-toggle="modal"
                                                                    data-target="#deleteFeesGroupModal<?php echo e($feesGroup->id); ?>"
...
<?php endif; ?>
                                                ...
                                                <div class="modal fade admin-query"
                                                    id="deleteFeesGroupModal<?php echo e($feesGroup->id); ?>">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mt-40 d-flex justify-content-between">
                                                                    ...
                                                                    <?php echo e(html()->form('POST', route('fees.fees-group-delete'))->open()); ?>

                                                                    <input type="hidden" name="id"
                                                                        value="<?php echo e($feesGroup->id); ?>">
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/gsistiww/public_html/portal/Modules/Fees/Resources/views/feesGroup.blade.php ENDPATH**/ ?>