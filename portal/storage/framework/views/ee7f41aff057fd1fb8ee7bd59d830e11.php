...
<?php $__env->startSection('mainContent'); ?>
    ...
    <section class="admin-visitor-area up_st_admin_visitor">
        <div class="container-fluid p-0">
            ...
            <?php echo e(html()->form('POST', route('student-attendance-bulk-store'))->attributes([
                    ...
                    <div class="white-box">
                        <div class="">
                            ...
                            <div class="row mb-40 mt-30">
                                <?php if ($__env->exists('university::common.session_faculty_depart_academic_semester_level',['mt'=>'mt-30','hide'=>['USUB'], 'required'=>['UA', 'UF', 'UD', 'US', 'USL','USEC']])) echo $__env->make('university::common.session_faculty_depart_academic_semester_level',['mt'=>'mt-30','hide'=>['USUB'], 'required'=>['UA', 'UF', 'UD', 'US', 'USL','USEC']], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            </div>
                            <?php else: ?>
                            <div class="row  mt-30">
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/gsistiww/public_html/portal/resources/views/backEnd/studentInformation/student_attendance_import.blade.php ENDPATH**/ ?>