                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 text-center">
                                                ...
                                                <?php if($errors->has('guardians_email')): ?>
                                                    <div class="error text-danger mt-2 mb-2"> <?php echo e('The guardians email field is required.'); ?> </div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div role="tabpanel" class="tab-pane fade" id="parents_and_guardian_info">
                                            <div class="row pt-4 row-gap-24">
                                                <div class="col-lg-12">
                                                    <div class="form-section">
                                                        <div class="row">
                                                            <?php if(generalSetting()->with_guardian  == 1): ?>
                                                                ...
                                                                <div class="col-lg-6 mt-4">
                                                                    <div class="primary_input ">
                                                                        <label class="primary_input_label"
                                                                            ...
                                                                            <?php if(is_required('guardians_email') && generalSetting()->with_guardian  == 1): ?>
                                                                                <span class="text-danger">
                                                                                    *</span>
                                                                            <?php endif; ?>
                                                                        </label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/gsistiww/public_html/portal/resources/views/backEnd/studentInformation/student_admission.blade.php ENDPATH**/ ?>