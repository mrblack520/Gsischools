<div>
    ...
    <div class="mb-40">
        ...
        <div class="white-box">
            ...
            <?php endif; ?>
            <?php echo $__env->make('backEnd.communicate._calendarSettingsForm', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </div>
    <?php endif; ?>
...
</div><?php /**PATH /home/gsistiww/public_html/portal/resources/views/backEnd/communicate/commonAcademicCalendar.blade.php ENDPATH**/ ?>