        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="white-box">
                    ...
                    <?php echo e(html()->form('POST', route('student-search'))->attributes([
                    ...
                    <div class="row">
                        ...
                        'required'=>['USEC']], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <div class="row mt-40">
            <div class="col-lg-12">
                <div class="white-box">
                        ...
                        <div class="col-lg-12 no-gutters">
                            <div class="main-title">
                                ...
                                <h3 class="mb-15"><?php echo app('translator')->get('student.student_attendance'); ?> | <small>
                                        ...
                                        <?php else: ?>
                                        <?php echo app('translator')->get('common.class'); ?>  : <?php echo e($search_info['class_name']); ?>, <?php echo app('translator')->get('common.section'); ?>  : <?php echo e($search_info['section_name']); ?>, <?php if(shiftEnable()): ?> <?php echo app('translator')->get('common.shift'); ?>  : <?php echo e($search_info['shift_name']); ?>, <?php endif; ?> <?php echo app('translator')->get('common.date'); ?>
                                        <?php endif; ?>   : <?php echo e(dateConvert($search_info['date'])); ?></small>
                                </h3>
                                <?php endif; ?>
                            </div>
                        </div>
                    ...
                    <?php echo e(html()->form('POST', route('student-attendance-store'))->class('form-horizontal')->open()); ?>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?php echo e($student->studentDetail->admission_no); ?>
                                                    ...
                                                    <?php if(shiftEnable()): ?>
                                                    <input type="hidden" name="attendance[<?php echo e($student->id); ?>][shift]"
                                                        value="<?php echo e($student->shift_id); ?>">
                                                    <?php endif; ?>
                                                    <?php if(moduleStatusCheck('University')): ?>
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/gsistiww/public_html/portal/resources/views/backEnd/studentInformation/student_attendance.blade.php ENDPATH**/ ?>