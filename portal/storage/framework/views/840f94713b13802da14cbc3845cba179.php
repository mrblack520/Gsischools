...
<?php $__env->startSection('mainContent'); ?>
    ...
    <section class="admin-visitor-area up_admin_visitor">
        <div class="container-fluid p-0">
            ...
            <?php endif; ?>
            <div class="row">
                <?php if(userPermission('visitor_store') || isset($visitor)): ?>
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            <?php if(isset($visitor)): ?>
                                <?php echo html()->form('POST', route('visitor_update'))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->open(); ?>

                                <input type="hidden" name="id" value="<?php echo e($visitor->id); ?>">
                            <?php else: ?>
                                <?php if(userPermission('visitor_store')): ?>
                                    <?php echo html()->form('POST', route('visitor_store'))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->open(); ?>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <input class="primary_input_field"
                                                    placeholder="<?php echo e(__('admin.no_of_person')); ?>" type="number"
                                                        ...
                                                        <div class="col">
                                                            <div class="">
                                                                <input class="primary_input_field primary_input_field time"
                                                                    type="text" name="in_time" placeholder="-"
                                                                    id="in_time"
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <div class="primary_file_uploader">
                                                    <input
                                                        class="primary_input_field form-control<?php echo e($errors->has('upload_event_image') ? ' is-invalid' : ''); ?>"
                                                        type="text" id="placeholderEventFile"
                                                        placeholder="<?php echo e(isset($visitor) ? ($visitor->file != '' ? getFilePath3($visitor->file) : trans('common.file')) : trans('common.file')); ?>"
                                                        readonly="">
                                                    <button class="" type="button">
                                                        <label class="primary-btn small fix-gr-bg"
                                                            for="upload_event_image"><span class="ripple rippleEffect"
                ...
                <?php endif; ?>
                <div class="<?php if(userPermission('visitor_store') || isset($visitor)): ?> col-lg-9 <?php else: ?> col-lg-12 <?php endif; ?>">
                    <div class="white-box">
...
<?php $component->withAttributes([]); ?>
                                    <table id="table_id" class="Crm_table_active3 table data-table" cellspacing="0"
                                        width="100%">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-40 d-flex justify-content-between">
                        ...
                        <?php echo html()->form('POST', route('visitor_delete'))->attribute('enctype', 'multipart/form-data')->open(); ?>
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/gsistiww/public_html/portal/resources/views/backEnd/admin/visitor.blade.php ENDPATH**/ ?>