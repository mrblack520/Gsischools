<div class="showAndHideSettings" style="display:none">
    <div>
        ...
        <div class="row mb-40">
              <div class="col-lg-12">
                <div>
                    <?php echo e(html()->form('post', route('store-academic-calendar-settings'))->open()); ?>
...
</div><?php /**PATH /home/gsistiww/public_html/portal/resources/views/backEnd/communicate/_calendarSettingsForm.blade.php ENDPATH**/ ?>