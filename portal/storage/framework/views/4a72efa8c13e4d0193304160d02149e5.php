...
<?php $__env->startSection('mainContent'); ?>
    ...
    <section class="admin-visitor-area up_admin_visitor">
        <div class="container-fluid p-0">
            ...
            <?php echo e(html()->form('post', route('admission-query-search'))->acceptsFiles()->attributes(['class' => 'form-horizontal', 'id' => 'infix_form'])->open()); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="primary_input mb-15">
                                    <label class="primary_input_label" for=""><?php echo app('translator')->get('admin.date_from'); ?> <span class="text-danger">*</span></label>
                            ...
                            <div class="col-lg-3">
                                <div class="primary_input mb-15">
                                    <label class="primary_input_label" for=""><?php echo app('translator')->get('admin.date_to'); ?> <span class="text-danger">*</span></label>
                                    <div class="primary_datepicker_input">
                                        <div class="no-gutters input-right-icon">
                                            <div class="col">
                                                <div class="">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-40 d-flex justify-content-between">
                        ...
                        <?php echo html()->form('POST', route('admission_query_delete'))->attribute('enctype', 'multipart/form-data')->open(); ?>
    ...
    <div class="modal fade admin-query" id="addQuery">
        <div class="modal-dialog modal-dialog-centered large-modal">
            <div class="modal-content">
                ...
                <?php echo html()->form('POST', route('admission_query_store_a'))
    ->attribute('enctype', 'multipart/form-data')
    ->attribute('id', 'admission-query-store')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="primary_input">
                                                ...
                                                <input type="number" oninput="phoneCheck(this)"
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/gsistiww/public_html/portal/resources/views/backEnd/admin/admission_query.blade.php ENDPATH**/ ?>