                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="white-box">
                            ...
                            <?php echo e(html()->form('GET', route('payroll'))->attributes([
...
<?php $component->withAttributes([]); ?>
                                                            <?php if(!empty($getPayrollDetails)): ?>
                                                                ...
                                                                <?php if($getPayrollDetails->payrollPayments): ?>
                                                                    <a class="dropdown-item modalLink" title="View Payroll Payment"  data-modal-size="modal-xl"  href="<?php echo e(route('view-payroll-payment', $getPayrollDetails->id)); ?>">
                                                                        <?php echo app('translator')->get('hr.view Payment'); ?>
                                                                    </a>
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/gsistiww/public_html/portal/resources/views/backEnd/humanResource/payroll/index.blade.php ENDPATH**/ ?>