            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        ...
                        <?php echo e(html()->form('POST', route('searchStaff'))->attributes([
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">  
                    ...
                    <div class="mt-40 d-flex justify-content-between">
                        ...
                        <?php echo e(html()->form('POST', route('delete_staff'))->attribute('enctype', 'multipart/form-data')->open()); ?>
...
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/gsistiww/public_html/portal/resources/views/backEnd/humanResource/staff_list.blade.php ENDPATH**/ ?>